...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	...
	<ul class="navbar-nav">
		<li class="nav-item"><a class="nav-link"
			href="${pageContext.request.contextPath}/bankbook/bankbookList"
		>Bankbook</a></li>
		...
		<c:if test="${not empty member }">
			<li class="nav-item"><a class="nav-link"
				href="${pageContext.request.contextPath }/member/memberPage"
			>Page</a></li>
			<li class="nav-item"><a class="nav-link"
		...
		> Dropdown link </a>
			<div class="dropdown-menu">
				...
				>Link 2</a> <a class="dropdown-item" href="#">Link 3</a>
			</div></li>
	</ul>
</nav>